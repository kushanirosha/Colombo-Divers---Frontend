    ...
    <div className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative text-center text-white px-6 md:px-12 max-w-3xl">
        ...
        >
          ...
          <span className="text-cyan-400">Colombo Divers</span>
        </motion.h1>
        <motion.p
        ...
        >
          <button className="bg-cyan-500 hover:bg-cyan-600 px-6 py-3 font-semibold text-white transition-all duration-300 shadow-lg">
            Book Your Dive
          </button>
          <button className="border-2 border-white hover:bg-white hover:text-black px-6 py-3 font-semibold transition-all duration-300">
            Learn More
          </button>
        </motion.div>
      </div>
