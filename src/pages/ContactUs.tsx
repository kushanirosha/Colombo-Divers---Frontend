...
function ContactUs() {
  ...
  const faqData = [
    ...
    {
      question: t("whatIsBestSeasonForDiving"),
      answer: t("whatIsBestSeasonForDivingAnswer"),
    },
    {
          ...
          >
            <div className="px-28">
              ...
              <div className="mb-10">
                ...
                <div>
                  <div className="font-semibold">Colombo Divers</div>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-6 text-sm">
                  <div>
                    ...
                    <div className="opacity-90">info@colombodivers.lk</div>
                  </div>
                  <div>
                    <div className="font-semibold">{t("contact")}</div>
                    <div className="opacity-90">+94 11 7835 456</div>
                  </div>
                </div>
              </div>
            </div>
